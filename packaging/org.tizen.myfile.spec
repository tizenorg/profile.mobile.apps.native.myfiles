...
cmake . -DCMAKE_INSTALL_PREFIX="%{PREFIX}" -DCMAKE_DESKTOP_ICON_DIR="%{TZ_SYS_RW_ICONS}/default/small" -DCMAKE_DESKTOP_DIR="%{TZ_SYS_RO_DESKTOP_APP}" -DCMAKE_INSTALL_PKG_NAME="%{name}" -DCMAKE_INSTALL_DATA_DIR="%{DATADIR}" -DCMAKE_APP_SHARE_PACKAGES_DIR="%{XMLDIR}"\
